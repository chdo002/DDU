...
import 'package:my_flutter/demo/index_page/subview/itemView1.dart';
import 'package:my_flutter/demo/index_page/subview/recommen_view.dart';
...
class HSQ1ListState extends State<HSQ1ListView> {
  ...
  void initState() {
    ...
    rootBundle.loadString('test/datas/item_list.json').then((value) {
      ...
      List<Map<String, dynamic>> recJsonList = jsonDic["recommend"].cast<Map<String, dynamic>>();
      var selectModel = HSQSelectRModel(recJsonList.map((e) => RecommendItem.fromJson(e)).toList());
